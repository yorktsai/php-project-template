<?php
namespace Facebook\Thrift\Scribe;
/**
...
interface scribeIf extends \Facebook\Thrift\FB303\FacebookServiceIf {
  public function Log($messages);
}

class scribeClient extends \Facebook\Thrift\FB303\FacebookServiceClient implements \Facebook\Thrift\Scribe\scribeIf {
  ...
  {
    $args = new \Facebook\Thrift\Scribe\scribe_Log_args();
  ...
  public function recv_Log()
  {
    ...
    if ($bin_accel) $result = thrift_protocol_read_binary($this->input_, '\Facebook\Thrift\Scribe\scribe_Log_result', $this->input_->isStrictRead());
    else
    {
      $rseqid = 0;
      $fname = null;
      ...
      $result = new \Facebook\Thrift\Scribe\scribe_Log_result();
    ...
    if (!isset(self::$_TSPEC)) {
      self::$_TSPEC = array(
        1 => array(
          ...
          'elem' => array(
            'type' => TType::STRUCT,
            'class' => '\Facebook\Thrift\Scribe\LogEntry',
            ),
          ),
        );
    }
      ...
      switch ($fid)
      {
        case 1:
          if ($ftype == TType::LST) {
            ...
            {
              $elem5 = null;
              $elem5 = new \Facebook\Thrift\Scribe\LogEntry();
...
class scribeProcessor extends \Facebook\Thrift\FB303\FacebookServiceProcessor {
